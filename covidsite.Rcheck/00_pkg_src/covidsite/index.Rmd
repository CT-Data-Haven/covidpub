...
<button class="btn btn-sm btn-default" role="button" data-toggle="collapse" data-target="#infoContainer" aria-controls="infoContainer" aria-expanded="true">Toggle</button>


::: {#infoContainer .panel .panel-default .collapse .in}
