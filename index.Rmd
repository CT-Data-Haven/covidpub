...
<div id="date-heading" class="text-info">
Latest statewide data: `r main_dates_fmt[2]` 
</div>
...
<button class="btn btn-sm btn-default" role="button" data-bs-toggle="collapse" type="button" data-target="#infoContainer" aria-controls="infoContainer" aria-expanded="false">Show / hide</button>

<div id="infoContainer" class="alert alert-info collapse" role="alert">
...
<div id="wellbeingNotes" class="alert alert-info">
